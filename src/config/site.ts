...
export const site: SiteConfig = {
  ...
  projects: {
    title: "Projects",
    categories: ["All", "Web", "Apps", "Games"],
    items: [
      {
        title: "Bookmarkify",
        href: "https://bookmarkify.in",
        category: "Web",
        image: "/screenshots/bookmarkify-site.png",
      },

      {
        ...
        category: "Web",
        image: "/screenshots/beercraft.png",
      },
      {
        title: "SMARTQ",
        href: "https://github.com/spratap124/Food-Ordering",
        category: "Web",
        image: "/screenshots/smartq.png",
      },
      {
        title: "Snake Game",
        href: "https://suryapratap.in/projects/SnakeGame_v1.html",
        category: "Games",
        image: "/screenshots/snake-game.png",
        linkLabel: "Open demo →",
      },
      {
        title: "Zombie Lane Shooter",
        href: "https://play.google.com/store/apps/details?id=com.zombielane.shooter",
        category: "Games",
        image: "/screenshots/zombie-lane-shooter.webp",
        linkLabel: "Download from Play Store →",
      },
      {
        title: "Tap Trap Animal",
        href: "https://play.google.com/store/apps/details?id=com.spratap.taptrapanimal",
        category: "Games",
        image: "/screenshots/tap-trap-animal.webp",
        linkLabel: "Download from Play Store →",
      },
      {
        title: "Bookmarkify - Chrome Extension",
        href: "https://chromewebstore.google.com/detail/bookmarkify/dnbnfomolmfanljmiaeenbmdefpiaadd",
        category: "Apps",
        image: "/screenshots/bookmarkify.png",
      },
      // {
      //   title: 'Game Lister',
      //   href: 'https://github.com/spratap124/Gamelister',
      //   category: 'Web',
      //   image: '/screenshots/game-lister.png',
      // },
    ],
  },
  contact: {
  ...
  footer: {
    note: "“Design is not just what it looks like — design is how it works.” — Steve Jobs",
  },
};
